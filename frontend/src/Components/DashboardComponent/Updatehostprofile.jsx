...
const Updatehostprofile = () => {
  ...
  const onSubmit = async(data)=>{
    ...
    for(let key in data){
      ...
      try {
          setLoading(true)
       const response = await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/v1/host/update-host-profile`,formdata,{
               headers:{
  ...
  return (
    <div className=" w-full rounded-2xl mt-10 bg-white p-10 font-normal leading-relaxed text-gray-900 shadow-xl">
